    ...
    return (
        <div className="flex w-full max-w-xl items-center gap-2">
            <select
                ...
                className="h-10 rounded-md bg-surface px-3 text-sm text-textPrimary outline-none border border-accent focus:border-highlight"
            >
                {REGIONS.map((r) => (
            ...
            <div className="relative flex-1">
                ...
                <button
                    ...
                    className="absolute left-3 top-1/2 -translate-y-1/2 text-textSecondary hover:text-textPrimary transition"
